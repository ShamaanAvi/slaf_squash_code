...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    validateCsrfToken();
    try {
        updatePlayerProfile($conn, $playerId, $_POST, (int)$_SESSION['user_id'], true);
        header("Location: " . redirectPath('home.php'));
        exit;
    } catch (Exception $e) {
        ...
        <div class="col-lg-7">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white py-3">
                    <h4 class="mb-0"><i class="bi bi-person-check me-2"></i>Complete Your Profile</h4>
                </div>
                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="dob" class="form-control" value="<?php echo e($profile['date_of_birth'] ?? $profile['dob'] ?? ''); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <button class="btn btn-primary btn-lg w-100"><i class="bi bi-check2-circle me-2"></i>Finish Setup</button>
                    </form>
                </div>
            </div>
        </div>
