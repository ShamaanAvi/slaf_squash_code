...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($verified || $legacyVerified) {
        ...
        registerUserSession($conn, (int)$user['id'], session_id(), 3, 600);
...
<head>
    ...
    <title>Login - Sri Lanka Squash Scoring System</title>
    ...
    <style>
        ...
        @media (max-width: 575.98px) {
            ...
            .login-card .card-body { padding: 2rem 1.25rem !important; }
        }
    </style>
</head>
<body>
    ...
    <div class="card login-card shadow mx-auto">
        <div class="card-body p-5">
            <div class="text-center mb-4">
                ...
                <h3 class="fw-bold mt-2">Sri Lanka Squash Scoring System</h3>
                <p class="text-muted">Login to your account</p>
            </div>

            <?php if(isset($_GET['timeout'])): ?>
                <div class="alert alert-warning py-2 small text-center">
                    <i class="bi bi-clock-history me-2"></i>Your session was idle for more than 10 minutes. Please login again.
                </div>
            <?php endif; ?>

            <?php if(isset($_GET['session_limit'])): ?>
                <div class="alert alert-warning py-2 small text-center">
                    <i class="bi bi-display me-2"></i>This account is already active in 3 newer sessions. Please login again if you want to continue here.
                </div>
            <?php endif; ?>
